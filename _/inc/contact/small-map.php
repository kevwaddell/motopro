<h3 class="icon-header visible-xs visible-sm" style="margin-bottom: 20px; margin-right: 0px;"><i class="fa fa-compass fa-lg"></i> Location</h3>
...
<script>
   ...
   function sml_map_init() {
    ...
    marker = new google.maps.Marker({position: myLatLang,map: sml_map,icon: image,title: "MotoPro"});
