<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
	...
	<h3><i class="icon fa fa-check"></i>General</h3>
	...
	<h3><a href="<?php echo get_permalink($legal_page->ID); ?>"><i class="icon fa fa-gavel"></i><?php echo $legal_page->post_title; ?><i class="fa fa-angle-right fa-lg"></i></a></h3>
