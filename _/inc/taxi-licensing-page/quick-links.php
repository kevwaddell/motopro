...
<section id="quick-links mag-bot-0" style="padding-top: 20px;">
	...
	<div class="row">
		<div class="col-md-6">
			<a href="<?php echo get_permalink($contact_page->ID); ?>?service=<?php echo urldecode($post->post_title); ?>#callback-request" class="link-btn icon-btn" title="<?php echo $contact_page->post_title; ?>"><i class="fa fa-phone fa-lg"></i><?php echo $contact_page->post_title; ?></a>
		</div>
		<div class="col-md-6">
